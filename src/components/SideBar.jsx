  ...
  return (
    <>
      ...
      >
        ...
        {/* Sidebar Links */}
        <ul className="space-y-3 font-medium sidebar-link block p-2 rounded-lg hover:bg-gray-700 transition">
          <li>
            <Link
              to="/home"
              className="block p-2 rounded-lg text-white hover:bg-gray-700 hover:text-white transition no-underline sidebar-link "
            >
              Home
            </Link>
          </li>
